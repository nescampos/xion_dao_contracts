...
use dao_testing::contracts::{
    cw20_base_contract, cw20_staked_balances_voting_contract, cw4_group_contract, xion_dao_contract,
    proposal_single_contract, v1_xion_dao_contract, v1_proposal_single_contract,
};
...
pub fn get_v1_code_ids(app: &mut App) -> (CodeIds, V1CodeIds) {
    let code_ids = CodeIds {
        core: app.store_code(v1_xion_dao_contract()),
...
pub fn get_v2_code_ids(app: &mut App) -> (CodeIds, V2CodeIds) {
    let code_ids = CodeIds {
        core: app.store_code(xion_dao_contract()),
