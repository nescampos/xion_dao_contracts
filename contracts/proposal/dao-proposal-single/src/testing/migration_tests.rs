...
use dao_testing::contracts::{
    ...
    xion_dao_contract, proposal_single_contract, v1_xion_dao_contract, v1_proposal_single_contract,
};
...
fn test_v1_v2_full_migration() {
    ...
    let core_code = app.store_code(v1_xion_dao_contract());
    ...
    let v2_core_code = app.store_code(xion_dao_contract());
