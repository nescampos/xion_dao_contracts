...
///
/// ```
/// use xion_dao_macros::voting_module_query;
...
///
/// ```
/// use xion_dao_macros::cw20_token_query;
/// use cosmwasm_schema::{cw_serde, QueryResponses};
...
///
/// ```
/// use xion_dao_macros::native_token_query;
/// use cosmwasm_schema::{cw_serde, QueryResponses};
/// use cosmwasm_std::Addr;
///
/// #[native_token_query]
...
///
/// ```
/// use xion_dao_macros::active_query;
/// use cosmwasm_schema::{cw_serde, QueryResponses};
///
/// #[active_query]
/// #[cw_serde]
...
///
/// ```
/// use xion_dao_macros::proposal_module_query;
/// use cosmwasm_schema::{cw_serde, QueryResponses};
/// use cosmwasm_std::Addr;
///
...
///
/// ```compile_fail
/// use xion_dao_macros::limit_variant_count;
///
