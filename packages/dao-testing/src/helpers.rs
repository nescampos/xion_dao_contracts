...
use crate::contracts::{
    ...
    cw20_staked_balances_voting_contract, cw4_group_contract, xion_dao_contract,
...
pub fn instantiate_with_cw20_balances_governance(
    ...
    let core_id = app.store_code(xion_dao_contract());
...
pub fn instantiate_with_staked_balances_governance(
    ...
    let core_contract_id = app.store_code(xion_dao_contract());
...
pub fn instantiate_with_staking_active_threshold(
    ...
    let governance_id = app.store_code(xion_dao_contract());
