...
pub fn xion_dao_contract() -> Box<dyn Contract<Empty>> {
    let contract = ContractWrapper::new(
        xion_dao_core::contract::execute,
        xion_dao_core::contract::instantiate,
        xion_dao_core::contract::query,
    )
    .with_reply(xion_dao_core::contract::reply)
    .with_migrate(xion_dao_core::contract::migrate);
    Box::new(contract)
}
...
pub fn v1_xion_dao_contract() -> Box<dyn Contract<Empty>> {
    let contract = ContractWrapper::new(
